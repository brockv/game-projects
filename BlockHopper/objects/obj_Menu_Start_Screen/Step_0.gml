...
var key_accept = keyboard_check_released(vk_enter) || gamepad_button_check_released(0, gp_face1); // || mouse_check_button_released(mb_right);
...
if (key_push == 1) Menu_System_Main();
