...
/// @description					Get the radius_ of the light for the instance
/// @param {real}	light_instance	The instance to get the radius_ of

// This getter script returns the radius_ of the given light source instance
...
// otherwise it will return the radius_ of the light source.
