...
//		create your own, it MUST have the parent "o_aura_light_parent"). IMPORTANT!
...
if (room = rm_init || room = rm_menu || room = rm_test) {
	Aura_Init(0.4, c_dkgray, true, 0, 2);
} else {
