...
var _select_width = sprite_get_width(s_select) / 2; // Get radius_ of the sprite
...
draw_sprite_ext(s_level_on, 0, _start_draw_x + (space * 3), _start_draw_y + (2 * space) + _select_width, cursor_scale_ * 2, cursor_scale_ * 2, 45, box_color, 1);
...
draw_sprite_ext(s_select, 0, _start_draw_x + space, _start_draw_y + (menu_pos_ * (space * 2)) - (space * 2) + _select_width, cursor_scale_, cursor_scale_, cursor_rotate_, c_white, 1);
