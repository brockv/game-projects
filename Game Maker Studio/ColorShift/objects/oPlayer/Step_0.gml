...
var kLeft, kRight, kUp, kDown, kJump, kJumpRelease, kNextColor, kPrevColor;
...
kNextColor    = keyboard_check_pressed(ord("E"))  || gamepad_button_check_pressed(0, gp_shoulderr);
kPrevColor    = keyboard_check_pressed(ord("Q"))  || gamepad_button_check_pressed(0, gp_shoulderl);
...
// Switch to the next / previous character
if (kNextColor) {
    // Morph effect
    xscale = 0.5;
    yscale = 1.5;
