...
__view_set( e__VW.WPort, global.display_view, (display_width*dpi)/global.display_zoom );
__view_set( e__VW.HPort, global.display_view, (display_height*dpi)/global.display_zoom ); 
